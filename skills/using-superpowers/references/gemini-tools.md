...
When a skill says to dispatch a subagent, use `@generalist` with the full prompt from the skill's prompt template:

| Skill instruction | Gemini CLI equivalent |
|-------------------|----------------------|
| `Task tool (general-purpose)` with `implementer-prompt.md` | `@generalist` with the filled `implementer-prompt.md` template |
| `Task tool (general-purpose)` with `spec-reviewer-prompt.md` | `@generalist` with the filled `spec-reviewer-prompt.md` template |
| `Task tool (general-purpose)` with `code-reviewer.md` | `@generalist` with the filled review prompt |
| `Task tool (general-purpose)` with `code-quality-reviewer-prompt.md` | `@generalist` with the filled `code-quality-reviewer-prompt.md` template |
